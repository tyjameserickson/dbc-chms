...
export function EditPersonForm({ person }: Props) {
  ...
  return (
    <div className="space-y-4">
      <Link href={`/people/${person.id}`} className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-900">
